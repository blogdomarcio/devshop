...
-- -----------------------------------------------------
-- Table `devshop`.`banners_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `devshop`.`banners_types` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `devshop`.`banners` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_banners_banners_types1_idx` (`banner_type_id` ASC) VISIBLE,
  CONSTRAINT `fk_banners_banners_types1`
    FOREIGN KEY (`banner_type_id`)
    REFERENCES `devshop`.`banners_types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE MyISAM;
